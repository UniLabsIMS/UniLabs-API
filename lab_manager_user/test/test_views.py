...
class TestViews(TestSetUp):
    ...
    def test_authenticated_admin_can_register_new_lab_managers(self):
        ...
        res = self.client.post(self.new_lab_manager_url,self.lab_manager_data,format="multipart")
    ...
    def test_cannot_add_lab_manager_with_no_email(self):
        ...
        data["email"]=""
        res = self.client.post(self.new_lab_manager_url,data,format="multipart")
