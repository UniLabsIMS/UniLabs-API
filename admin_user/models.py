...
class AdminManager(BaseUserManager):
    ...
    def create_admin(self,email):
        ...
        # TODO: password = DefaultPasswords.DEFAULT_DEBUG_ADMIN_PASSWORD if (config('DEBUG','True')=='True') else self.make_random_password() # password is randomly generated when an admin is created
        password = DefaultPasswords.DEFAULT_DEBUG_ADMIN_PASSWORD
