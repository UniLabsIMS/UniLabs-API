...
urlpatterns=[
    ...
    path('approved-request-items/<str:lab_id>/<str:student_id>', ApprovedRequestItemsListFromLabForStudentAPIView.as_view(), name='approved-display-items-in-lab-for-student'),# tests needed
    path('clear-approved-request-items/', ClearApprovedRequestItemsFromLabForStudentAPIView.as_view(), name='clear-approved-display-items'), # tests needed
]